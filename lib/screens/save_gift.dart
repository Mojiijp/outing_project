...
class SaveGiftScreen extends StatefulWidget {
  const SaveGiftScreen({super.key});

  @override
  State<SaveGiftScreen> createState() => _SaveGiftScreenState();
}
enum GiftRadio { thousand, eightHundred, fiveHundred}

class _SaveGiftScreenState extends State<SaveGiftScreen> {
